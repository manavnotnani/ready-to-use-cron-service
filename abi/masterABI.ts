export const MASTER_ABI: any = [
  {
    inputs: [
      { internalType: "address", name: "router", type: "address" },
      { internalType: "bytes32", name: "_donId", type: "bytes32" },
      { internalType: "address", name: "_udst", type: "address" },
    ],
